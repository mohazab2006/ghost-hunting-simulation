...
void house_populate_rooms(struct House* house) {
    ...
    // Index rooms based on their position in the array for deterministic locking order
...
const char* evidence_to_string(enum EvidenceType evidence) {
    switch (evidence) {
        case EV_EMF:          return "emf";
        case EV_ORBS:         return "orbs";
        case EV_RADIO:        return "radio";
        case EV_TEMPERATURE:  return "temp";
        case EV_FINGERPRINTS: return "prints";
        case EV_WRITING:      return "writing";
        case EV_INFRARED:     return "infrared";
...
const char* ghost_to_string(enum GhostType ghost) {
    switch (ghost) {
        case GH_POLTERGEIST:  return "poltergeist";
        case GH_THE_MIMIC:    return "the_mimic";
        case GH_HANTU:        return "hantu";
        case GH_JINN:         return "jinn";
        case GH_PHANTOM:      return "phantom";
        case GH_BANSHEE:      return "banshee";
        case GH_GORYO:        return "goryo";
        case GH_BULLIES:      return "bullies";
        case GH_MYLING:       return "myling";
        case GH_OBAKE:        return "obake";
        case GH_YUREI:        return "yurei";
        case GH_ONI:          return "oni";
        case GH_MOROI:        return "moroi";
        case GH_REVENANT:     return "revenant";
        case GH_SHADE:        return "shade";
        case GH_ONRYO:        return "onryo";
        case GH_THE_TWINS:    return "the_twins";
        case GH_DEOGEN:       return "deogen";
        case GH_THAYE:        return "thaye";
        case GH_YOKAI:        return "yokai";
        case GH_WRAITH:       return "wraith";
        case GH_RAIJU:        return "raiju";
        case GH_MARE:         return "mare";
        case GH_SPIRIT:       return "spirit";
        default:              return "unknown";
    }
}
...
const char* exit_reason_to_string(enum LogReason reason) {
    switch (reason) {
        case LR_EVIDENCE: return "evidence";
        case LR_BORED:    return "bored";
        case LR_AFRAID:   return "afraid";
        default:          return "unknown";
    }
}
...
// ---- Logging (Writes CSV logs, DO NOT MODIFY FILE FORMAT) ----
...
static const char* log_entity_type_to_string(enum LogEntityType type) {
    switch (type) {
        case LOG_ENTITY_HUNTER: return "hunter";
        case LOG_ENTITY_GHOST:  return "ghost";
        default:                return "unknown";
    }
}
